...
const Permission = () => {
    return (
        <Container className="pb-5 lead">
            ...
            <li>
            <p><strong>Website</strong> refers to The Coding Cavalry, accessible from <a href="https:://thecodingcavalry.com" rel="external nofollow noopener" target="_blank">https:://thecodingcavalry.com</a></p>
            </li>
            <li>
