...
const privacy = () => {
    return (
        <>
            <Head>
                <title>The Coding Cavalry | Privacy Policy</title>
            ...
            <Container className="lead py-5">
                ...
                <li>
                <p><strong>Website</strong> refers to The Coding Cavalry, accessible from <a href="http://www.thecodingcavalry.com">http://www.thecodingcavalry.com</a></p>
                </li>
                <li>
                ...
                <li>
                <p>By visiting this page on our website: <a href="http://www.thecodingcavalry.com/contact">http://www.thecodingcavalry.com/contact</a></p>
                </li>
                </ul>
            </Container>
        </>
